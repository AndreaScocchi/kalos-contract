-- =============================================================================
-- Create activities storage bucket for activity images
-- =============================================================================
...
CREATE POLICY "activities_staff_insert" ON storage.objects
...
CREATE POLICY "activities_staff_update" ON storage.objects
...
CREATE POLICY "activities_staff_delete" ON storage.objects
...
CREATE POLICY "activities_public_read" ON storage.objects
