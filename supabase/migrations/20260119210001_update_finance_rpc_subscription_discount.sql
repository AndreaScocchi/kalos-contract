-- Migration: Update Finance RPC Functions to consider subscription-level discount
-- Priority: custom_price_cents > subscription.discount_percent > plan.discount_percent

-- Update calculate_operator_compensation to consider subscription discount
...
-- Update get_monthly_revenue_by_client to consider subscription discount
...
-- Update get_monthly_revenue_by_plan to consider subscription discount
